...
<body>
    ...
    <section class="p-1 my-container ">
        <div class="container m-p-0">
            ...
            <div class="card ">
                <div class="card-header text-center font-weight-bold">Daftar Mahasiswa Informatika Yang Sudah Lulus Skripsi</div>
                <div class="card-body">
