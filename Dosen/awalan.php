                        ...
                        <div class="row">
                            <div class="col p-0 mt-5">
                                <h1>
                                    ...
                                    $jumlah_mahasiswa = mysqli_num_rows($jumlah);
                                ...
                                <h1>
                                    <?php
                                    $jumlah = mysqli_query($koneksi, "SELECT * FROM mahasiswa WHERE status_mhs='cuti'");
                                    $jumlah_mahasiswa = mysqli_num_rows($jumlah);
                                    echo $jumlah_mahasiswa;
                                    ?>
                                </h1>
                                <h2>Mahasiswa Cuti</h2>

                            </div>
                            <div class="col">
                                <?php include("chart/index-pdo.php"); ?>
                            </div>
                        </div>
                    </div>
                </div>
